...
```
These are the graphs of the pollutants over year. As shown in the graphs, the concentrations of each pollutant have decreased due to effective environmental regulation. The graphs show the 10th percentile, 90th percentile, and the mean concentrations of the pollutant
...
#Here we display the concentration of ozone trend in each region. The ozone levels have been decreasing in the past 20 years due to earlier effective environmental regulation. 
#The Western States have the most ozone due to oil and gas extraction and are also known for having the most amount of sunlight. 
...
#The areas where NO2 is naturally very high are the urban areas which is prevalent in the Northeast and California.
...
#Sulfur Dioxide is most prevalent in the Southwest and Central Region while being least prevalent in the West.
