...
summary(lm(data = focus_data, delta.aqi.state ~ is.climate.alli)
```
...
set.seed(1)
X <- model.matrix(delta.aqi.state~., glmnet_data)[,-1]
...
\tiny
``` {r anova1}
fit.lm <- update(fit.lm, .~. -UnempRate2013)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -OwnHomePct)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -PctEmpTrans)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -PctEmpChange0710)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -PctEmpConstruction)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -ForeignBornAfricaPct)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -UnempRate2020)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -MedHHInc)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -AsianNonHispanicPct2010)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -PctEmpInformation)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -BlackNonHispanicPct2010)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -NetMigrationRate1019)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -PctEmpGovt)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -AsianNonHispanicPct2010)
Anova(fit.lm)
...
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -UnempRate2007)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -Ed1LessThanHSPct)
Anova(fit.lm)
fit.lm <- update(fit.lm, .~. -NonHispanicBlackPopChangeRate0010)
Anova(fit.lm)
```
...
```{r lasso test}
lasso.fit.pred <- predict(fit.final, lm_cols)
MSE_test <- mean((lm_cols$med.aqi - lasso.fit.pred)^2)
MSE_null <- mean((lm_cols$med.aqi - mean(lm_cols$med.aqi))^2)
```
